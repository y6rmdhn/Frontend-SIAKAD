...
const adminServices = {
  ...
  getMasterPangkatReferensi: (params?: {
    is_dropdown?: boolean;
    page?: number;
    limit?: number;
    search?: string;
  ...
  getMasterEselonReferensi: (params?: {
    is_dropdown?: boolean;
    page?: number;
    limit?: number;
    search?: string;
  ...
  getJenisSertifikasiReferensi: (params?: {
    is_dropdown?: boolean;
    page?: number;
    limit?: number;
    search?: string;
  ...
  getJenisPenghargaanAktifitas: (params?: {
    is_dropdown?: boolean;
    page?: number;
    limit?: number;
    search?: string;
  ...
  getMonitoringValidasiData: (params?: {
    status?: string;
    page?: number;
    limit?: number;
  }) => {
