const accordionContent = [
  {
    ...
    items: [
      ...
      { label: "Pangkat", href: "/admin/detail-pegawai/kepegawaian/pangkat/" },
      {
        ...
        href: "/admin/detail-pegawai/kepegawaian/jabatan-akademik/",
      },
      {
        label: "Jabatan Fungsional",
        href: "/admin/detail-pegawai/kepegawaian/jabatan-fungsional/",
      },
      {
        label: "Jabatan Struktural",
        href: "/admin/detail-pegawai/kepegawaian/jabatan-struktural/",
      },
      {
        label: "Hubungan Kerja",
        href: "/admin/detail-pegawai/kepegawaian/hubungan-kerja/",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        href: "/admin/detail-pegawai/presensi/",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        href: "/admin/detail-pegawai/kualifikasi/pendidikan-formal/",
      },
      { label: "Diklat", href: "/admin/detail-pegawai/kualifikasi/diklat/" },
      {
        label: "Riwayat Pekerjaan",
        href: "/admin/detail-pegawai/kualifikasi/riwayat-pekerjaan/",
      },
    ],
  },
  {
    ...
    items: [
      {
        label: "Sertifikasi",
        href: "/admin/detail-pegawai/kompetensi/riwayat-sertifikasi/",
      },
  ...
  },
  {
    ...
    items: [
      {
        label: "Organisasi",
        href: "/admin/detail-pegawai/pengembangan/organisasi/",
      },
      {
        label: "Kemampuan Bahasa",
        href: "/admin/detail-pegawai/pengembangan/kemampuan-bahasa/",
      },
    ],
  },
  {
    ...
    items: [
      {
        label: "Pelanggaran",
        href: "/admin/detail-pegawai/kompensasi/",
      },
    ],
  },
  {
    title: "Permohonan",
    items: [
      { label: "Cuti", href: "/admin/detail-pegawai/permohonan/cuti/" },
      { label: "Izin", href: "/admin/detail-pegawai/permohonan/izin/" },
    ],
  },
];
