// src/components/blocks/InfiniteScrollSelect/InfiniteScrollSelect.tsx
...
export const InfiniteScrollSelect = ({
    ...
    const {
        ...
        getNextPageParam: (lastPage) => {
            ...
            if (!paginationInfo || paginationInfo.current_page >= paginationInfo.last_page) {
    ...
    const options = data?.pages.flatMap(page => page?.data?.data).filter(Boolean) ?? [];
                        ...
                        >
                            <FormControl>
                                <SelectTrigger className="w-full text-xs">
                                    <SelectValue placeholder={isLoading ? "Memuat data..." : placeholder} />
                                </SelectTrigger>
                            </FormControl>
                            <SelectContent>
