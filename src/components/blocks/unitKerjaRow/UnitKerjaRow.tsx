// File: components/UnitKerjaRow.tsx
...
// Sesuaikan tipe data ini jika perlu
interface UnitNode {
  kode_unit: string;
  nama_unit: string;
...
const UnitKerjaRow: React.FC<UnitKerjaRowProps> = ({
  ...
  return (
    <React.Fragment>
      ...
      {/* PANGGILAN REKURSIF: Render anak-anak dari baris ini jika terbuka */}
      {isRowOpen &&
