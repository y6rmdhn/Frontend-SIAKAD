...
const DasboardUser = () => {
  ...
  const {data: historyAbsen} = useQuery({
            ...
            <div>
                <div className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col lg:flex-row w-full gap-5 md:gap-2">
                        {!sudahMasuk ? (
                            <Button onClick={() => handleBukaModal('masuk')}
                            ...
                            <Button onClick={() => handleBukaModal('keluar')}
                        ...
                        <Dialog>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    <DialogTitle className="text-center text-sm">Riwayat Hadir</DialogTitle>
                                    <Table className="table-auto text-xs lg:text-sm">
                                        <TableHeader>
                                            <TableRow className="bg-[#002E5A] ">
                                                <TableHead className="text-center text-white border">Tanggal</TableHead>
                                                <TableHead className="text-center text-white border">Jam Masuk </TableHead>
                                                <TableHead className="text-center text-white border">Jam Keluar</TableHead>
                                            </TableRow>
                                        </TableHeader>
