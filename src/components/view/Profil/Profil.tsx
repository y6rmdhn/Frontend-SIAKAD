                        ...
                        <div className="absolute flex-col py-5 md:py-0 md:flex-row top-0 w-full h-full px-4 sm:px-10 flex justify-between items-center">
                            <div className="flex gap-4 items-center">
                                ...
                                <div className="flex flex-col text-white">
                                    ...
                                    <Label className="text-sm font-bold">UNIVERSITAS IBN KHALDUN</Label>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3 items-center md:flex-col md:items-end lg:flex-row lg:items-center">
                                <Link to={"/"}>
                                    <Button className="bg-[#00325B]/50 hover:bg-[#00325B]/70 cursor-pointer">
                                        <MdOutlineViewModule className="text-2xl text-white" /> Daftar Modul
                                    </Button>
                                </Link>
                                <Button
                    ...
                    <div className="bg-[#F4F3F3] h-full">
                        <div className="grid grid-rows px-4 sm:px-7 pb-8 lg:mb-0 lg:grid-cols h-full">
                            <div className="w-full h-full pt-5 order-2 lg:order-1 flex flex-col gap-3">
                                <Label className="font-semibold text-base sm:text-xl">Foto Profile</Label>
                                <div className="sm:px-7">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-2">
                                        ...
                                        <Button className="bg-[#3A6BF2] text-xs sm:text-sm" onClick={triggerFileInput}>
                                            <MdOutlinePhotoLibrary />
                                            Ganti Foto
                                        </Button>


                                        <Button className="bg-[#E72D30] text-xs sm:text-sm" onClick={handlePhotoRemove}>
                                            <HiX />
                                            Hapus Foto
                                        </Button>
                                ...
                                <Label className="font-semibold text-sm sm:text-base">Email Anda Sudah diverifikasi</Label>
                                <Label className="text-xs sm:text-sm">jika ingin mengubah email, silahkan hubungi admin perguruan tinggi</Label>
                                <div className="flex flex-col sm:flex-row items-start gap-3 my-2">
                                    ...
                                    <div className="flex flex-col w-full sm:w-70">
                                        ...
                                        />
                                        <Label className="text-[#11A60F] mt-1 text-xs sm:text-sm">Email sudah diverifikasi</Label>
                                    </div>
                                </div>
                                <div>
                                    <Label className="text-base font-semibold text-sm sm:text-base">Ganti Kata Sandi</Label>
