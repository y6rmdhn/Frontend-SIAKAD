...
const Penelitian = () => {
    return (
        <div className="mt-10 mb-20">
            <Title title="Penelitian" subTitle="Daftar Penelitian" />
            <CustomCard
                actions={
                    <div className="flex justify-end">
                        <Link to="/data-riwayat/pelaksanaan-penelitian/detail-penelitian">
            ...
            <Table className="mt-10 table-auto">
                <TableHeader>
                    <TableRow className="bg-[#E7ECF2] ">
                        ...
                        <TableHead className="text-center text-black">Judul Penelitian</TableHead>
                        <TableHead className="text-center text-black">Perguruan Tinggi Afiliasi</TableHead>
