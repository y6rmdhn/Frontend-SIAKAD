...
const Publikasi = () => {
    return (
        <div className="mt-10 mb-20">
            <Title title="Publikasi" subTitle="Daftar Publikasi" />
            <CustomCard
                actions={
                    <div className="flex justify-end">
                        <Link to="/data-riwayat/pelaksanaan-penelitian/detail-publikasi">
            ...
            <Table className="mt-10 table-auto">
                <TableHeader>
                    <TableRow className="bg-[#E7ECF2] ">
                        ...
                        <TableHead className="text-center text-black">Judul</TableHead>
                        <TableHead className="text-center text-black">Jenis Publikasi</TableHead>
                        <TableHead className="text-center text-black">Tgl terbit</TableHead>
