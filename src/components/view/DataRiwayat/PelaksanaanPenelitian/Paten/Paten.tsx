...
const Paten = () => {
    return (
        <div className="mt-10 mb-20">
            <Title title="Paten" subTitle="Daftar Paten" />
            <CustomCard
                actions={
                    <div className="flex justify-end">
                        <Link to="/data-riwayat/pelaksanaan-penelitian/detail-paten">
            ...
            <Table className="mt-10 table-auto">
                <TableHeader>
                    <TableRow className="bg-[#E7ECF2] ">
                        ...
                        <TableHead className="text-center text-black">Jenis</TableHead>
