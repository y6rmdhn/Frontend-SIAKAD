...
const JabatanFungsional = () => {
  ...
  const { data: rawData, isLoading } = useQuery<PaginatedData>({
    queryKey: ["jabatan-fungsional-pegawai", currentPage, currentSearch],
    queryFn: async () => {
      ...
      <Table className="mt-10 table-auto text-xs lg:text-sm">
        <TableHeader>
          <TableRow className="bg-gray-300">
            ...
            <TableHead className="text-center text-black">Jab. Fungsional</TableHead>
            <TableHead className="text-center text-black">Angka Kredit</TableHead>
            ...
            items.map((item) => (
              <TableRow key={item.id} className="even:bg-gray-100">
                ...
                <TableCell className="text-center">
                  {item.jabatan_fungsional?.nama || "-"}
                </TableCell>
                <TableCell className="text-center">{item.angka_kredit ?? "0"}</TableCell>
