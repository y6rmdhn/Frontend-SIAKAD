...
const DetailJabatanAkademik = () => {
    ...
    const {mutate} = useMutation({
        mutationFn: (formData: FormData) => postDosenServices.addDataJabatanAkademik(formData),
        onSuccess: (response) => {
                    ...
                    <div className="mt-10 grid md:grid-rows-3 md:grid-flow-col md:items-center gap-6 w-full">
                        <FormFieldSelect
                            ...
                            options={[
                                ...
                                {value: "3", label: "Dosen Praktisi/Industri"},
                                {value: "4", label: "Guru Besar"},
                                {value: "5", label: "Guru Pamong"},
                                {value: "6", label: "Administrasi"},
                                {value: "7", label: "Keamanan"},
                                {value: "8", label: "Laboran"},
                                {value: "9", label: "Pustakawan"},
                                {value: "10", label: "Parkir"},
                                {value: "11", label: "Lektor"},
                                {value: "12", label: "Lektor Kepala"},
                                {value: "13", label: "Dosen"},
                                {value: "14", label: "Rumah Tangga"},
                                {value: "15", label: "Sopir"},
                                {value: "16", label: "Tenaga Ahli"},
                                {value: "17", label: "Tenaga Pengajar"},
                            ]}
                            required={true}
