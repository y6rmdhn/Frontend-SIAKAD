...
const PenunjangLain = () => {
  return (
    <div className="mt-10 mb-20">
      <Title title="Penunjang Lain" subTitle="Daftar Penunjang Lain" />
      <CustomCard
        actions={
          <div className="flex justify-end">
            <Link to="/data-riwayat/penunjang/detail-penunjang-lain">
      ...
      <Table className="mt-10 table-auto">
        <TableHeader>
          <TableRow className="bg-gray-300 ">
            ...
            <TableHead className="text-center text-black text-xs sm:text-sm">Nama Kegiatan</TableHead>
            <TableHead className="text-center text-black text-xs sm:text-sm">Instansi Penyelenggara</TableHead>
            <TableHead className="text-center text-black text-xs sm:text-sm">Tanggal</TableHead>
          ...
          <TableRow className=" even:bg-gray-100">
            ...
            <TableCell className="h-full">
              <div className="flex justify-center items-center w-full h-full">
                <Link to="/data-riwayat/penunjang/detail-data-penunjang-lain">
                  <Button
                    size="icon"
                    variant="ghost"
