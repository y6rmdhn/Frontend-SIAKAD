                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 border border-gray-200 rounded-lg p-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex flex-col sm:flex-row gap-2 justify-between border-b p-2">
                                    <Label className="font-semibold text-[#2572BE] text-xs sm:text-sm">Tahun</Label>
                                    <Label className="text-xs sm:text-sm font-semibold">{data?.data.tahun || '-'}</Label>
                                </div>
                                <div className="flex flex-col sm:flex-row gap-2 justify-between border-b p-2">
                                    <Label className="font-semibold text-[#2572BE] text-xs sm:text-sm">Bahasa</Label>
                                    <Label className="text-xs sm:text-sm font-semibold">{data?.data.nama_bahasa || '-'}</Label>
                                </div>
                                <div className="flex flex-col sm:flex-row gap-2 justify-between border-b p-2">
                                    <Label className="font-semibold text-[#2572BE] text-xs sm:text-sm">Nama Lembaga</Label>
                                    <Label className="text-xs sm:text-sm font-semibold">{data?.data.nama_lembaga || '-'}</Label>
                                </div>
                                <div className="flex flex-col sm:flex-row gap-2 justify-between border-b p-2">
                                    <Label className="font-semibold text-[#2572BE] text-xs sm:text-sm">Kemampuan Mendengar</Label>
                                    <Label className="text-xs sm:text-sm font-semibold">{data?.data.kemampuan_mendengar || '-'}</Label>
                                </div>
                                <div className="flex flex-col sm:flex-row gap-2 justify-between border-b p-2">
                                    <Label className="font-semibold text-[#2572BE] text-xs sm:text-sm">Kemampuan Berbicara</Label>
                                    <Label className="text-xs sm:text-sm font-semibold">{data?.data.kemampuan_bicara || '-'}</Label>
                                </div>
                                <div className="flex flex-col sm:flex-row gap-2 justify-between border-b p-2">
                                    <Label className="font-semibold text-[#2572BE] text-xs sm:text-sm">Kemampuan Menulis</Label>
                                    <Label className="text-xs sm:text-sm font-semibold">{data?.data.kemampuan_menulis || '-'}</Label>
                                </div>
                            </div>
