...
const ACCEPTED_MIME_TYPES = ["application/pdf", "image/jpeg", "image/png"]; // Izinkan PDF/JPG/PNG
...
const detailDiklatSchema = z.object({
    ...
    tahun_penyelenggaraan: z.string().min(4, "Tahun tidak valid.").max(4, "Tahun tidak valid."),
...
const DetailDiklat = () => {
    ...
    const {mutate} = useMutation({
        mutationFn: (formData: FormData) => postDosenServices.addDataDiklat(formData),
        onSuccess: (response) => {
                    ...
                    <CustomCard
                        actions={
                            <div>
                                ...
                                <div
                                    className="mt-10 grid md:grid-rows-8 md:grid-flow-col md:items-center gap-6 w-full">
                                    {/* Kolom Kiri */}
                                    <FormFieldSelect
                                        label="Jenis Diklat"
                                        name="jenis_diklat"
                                        ...
                                        options={[
                                            ...
                                            {value: "applied_approach", label: "Applied Approach (Paket)"},
                                            {value: "diklat_prajabatan", label: "Diklat Prajabatan (Non-Pekerti)"},
                                            {value: "diklat_kepemimpinan", label: "Diklat Kepemimpinan (Non-Pekerti)"},
                                            {value: "academic_exchange", label: "Academic Exchange (Non-Paket)"},
                                            {
