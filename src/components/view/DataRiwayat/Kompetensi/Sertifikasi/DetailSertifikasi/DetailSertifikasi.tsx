                        ...
                        <div className="space-y-4 mt-20">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex gap-14">
                                        <Label className="w-50 text-[#2572BE]">
                                            Nomor Sertifikasi<span className="text-red-500">*</span>
                                        </Label>
                                        <Select>
                                            <SelectTrigger className="w-full">
                                                <SelectValue placeholder="- - pilih Nomor Sertifikasi - -" />
                                            </SelectTrigger>
                                            <SelectContent>
                                ...
                                <div className="flex gap-14">
                                    ...
                                    <div className="flex gap-14">
                                        <Label className="w-50 text-[#2572BE]">
                                            Tanggal Sertifikasi<span className="text-red-500">*</span>
                                        </Label>
                                    ...
                                    <div className="flex gap-14">
                                        ...
                                        <Select>
                                            ...
                                            <SelectContent>
                                                <SelectItem value="br">lingkup 1</SelectItem>
                                                <SelectItem value="lm">lingkup 2</SelectItem>
                                                <SelectItem value="lain">Lainnya</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </div>
