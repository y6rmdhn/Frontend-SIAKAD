...
const DetailDataPembimbingDosen = () => {

    return (
        <div className="mt-10 mb-20">
            <Title title="Pembimbing Dosen" subTitle="Detail Pembimbing Dosen" />
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex justify-end">
                            <Link
                                ...
                                to="/data-riwayat/pelaksanaan-pendidikan/pembimbing-dosen"
                            >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 border border-black rounded-lg p-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex flex-col sm:flex-row gap-2 justify-between border-b p-2">
                                    <Label className="font-semibold text-[#2572BE] text-xs sm:text-sm shrink-0 w-38">Program Studi</Label>
                                    <Label className="text-xs sm:text-sm font-semibold">S1 Teknik Informatika</Label>
                                </div>
                                <div className="flex flex-col sm:flex-row gap-2 justify-between border-b p-2">
                                ...
                                <div className="flex flex-col sm:flex-row gap-2 justify-between border-b p-2">
                                    <Label className="font-semibold text-[#2572BE] text-xs sm:text-sm shrink-0 w-38">Jenis Bimbingan</Label>
                                    <Label className="text-xs sm:text-sm font-semibold">Reguler</Label>
                                </div>
                                <div className="flex flex-col sm:flex-row gap-2 justify-between border-b p-2">
                                    <Label className="font-semibold text-[#2572BE] text-xs sm:text-sm shrink-0 w-38">Dosen Bimbingan</Label>
                                    <Label className="text-xs sm:text-sm font-semibold">[Nullable]</Label>
                                </div>
                                <div className="flex flex-col sm:flex-row gap-2 justify-between border-b p-2">
                                    <Label className="font-semibold text-[#2572BE] text-xs sm:text-sm shrink-0 w-38">Bidang Ahli Bimbingan</Label>
                                    <Label className="text-xs sm:text-sm font-semibold"></Label>
                                </div>
                                <div className="flex flex-col sm:flex-row gap-2 justify-between border-b p-2">
                                    <Label className="font-semibold text-[#2572BE] text-xs sm:text-sm shrink-0 w-38">Deskripsi Kegiatan</Label>
                                    <Label className="text-xs sm:text-sm font-semibold"></Label>
                                </div>
                                <div className="flex flex-col sm:flex-row gap-2 justify-between border-b p-2">
