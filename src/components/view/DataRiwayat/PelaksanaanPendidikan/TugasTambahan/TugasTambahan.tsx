...
const TugasTambahan = () => {
  return (
    <div className="mt-10 mb-20">
      <Title title="Tugas Tambahan" subTitle="Daftar Tugas Tambahan" />
      <CustomCard
        actions={
          <div className="flex justify-end ">
            <Link to="/data-riwayat/pelaksanaan-pendidikan/detail-tugas-tambahan">
      ...
      <Table className="mt-10 table-auto text-xs lg:text-sm">
        <TableHeader>
          <TableRow className="bg-gray-100">
            <TableHead className="text-center">Tugas Tambahan</TableHead>
            <TableHead className="text-center">
              Perguruan Tinggi Penugasan
            </TableHead>
            <TableHead className="text-center">Terhitung Mulai Tgl</TableHead>
          ...
          <TableRow className=" even:bg-gray-100">
            ...
            <TableCell className="h-full">
              <div className="flex justify-center items-center w-full h-full">
                <Link to="/data-riwayat/pelaksanaan-pendidikan/detail-data-tugas-tambahan">
                  <Button
                    size="icon"
                    variant="ghost"
