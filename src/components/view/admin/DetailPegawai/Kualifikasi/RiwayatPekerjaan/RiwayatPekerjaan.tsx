...
const RiwayatPekerjaan = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: [
      "riwayat-pekerjaan-detail-pegawai",
      params.id,
      searchParam.get("page"),
      searchParam.get("search"),
    ],
    queryFn: async () => {
      const response = await adminServices.getRiwayatPekerjaanDetailPegawai(
  ...
  return (
    <DetailPegawaiLayout
      ...
      subTitile="Daftar Riwayat Pekerjaan"
    >
      {/*Sidebar*/}
                ...
                <TableRow key={item.id}>
                  ...
                  <TableCell className="h-full">
                    <div className="flex justify-center items-center w-full h-full">
                      <Link
                        to={`/admin/kepegawaian/riwayat-pekerjaan/detail/${item.id}`}
                      >
                        <Button
                          size="icon"
                          variant="ghost"
