...
const Pelanggaran = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: [
      "pelanggaran-detail-pegawai",
      params.id,
      searchParam.get("page"),
      searchParam.get("search"),
    ],
    queryFn: async () => {
      const response = await adminServices.getPelanggaranDetailPegawai(
  ...
  return (
    <DetailPegawaiLayout
      title="Pelanggaran"
      subTitile="Daftar Riwayat Pelanggaran"
    >
      {/*Sidebar*/}
                ...
                <TableRow key={item.id}>
                  ...
                  <TableCell className="h-full">
                    <div className="flex justify-center items-center w-full h-full">
                      <Link
                        to={`/admin/kepegawaian/pelanggaran/detail/${item.id}`}
                      >
                        <Button
                          size="icon"
                          variant="ghost"
