...
const Cuti = () => {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await adminServices.getCutiDetailPegawai(
  ...
  return (
    <DetailPegawaiLayout title="Cuti" subTitile="Daftar Permohonan Cuti">
      {/*Sidebar*/}
                ...
                <TableRow key={item.id}>
                  ...
                  <TableCell className="h-full">
                    <div className="flex justify-center items-center w-full h-full">
                      <Link to={`/admin/kepegawaian/cuti/detail/${item.id}`}>
                        <Button
                          size="icon"
                          variant="ghost"
