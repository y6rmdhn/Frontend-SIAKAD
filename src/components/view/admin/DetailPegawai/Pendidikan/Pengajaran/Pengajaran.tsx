...
const Pengajaran = () => {
  ...
  return (
    <DetailPegawaiLayout title="Pengajaran" subTitile="Daftar Pengajaran">
      {/*Sidebar*/}
        ...
        <Table className="mt-10 table-auto border-separate border-spacing-x-[1px]">
          <TableHeader>
            <TableRow className="bg-[#004680]">
              ...
              <TableHead className="text-center text-white">Kode MK</TableHead>
              <TableHead className="text-center text-white">Nama MK</TableHead>
              <TableHead className="text-center text-white">SKS MK</TableHead>
