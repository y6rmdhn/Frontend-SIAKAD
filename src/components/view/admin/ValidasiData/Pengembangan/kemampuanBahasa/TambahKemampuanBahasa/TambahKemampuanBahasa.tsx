...
const formSchema = z.object({
    ...
    skor_mendengar: z.string().min(1, "Skor mendengar wajib diisi."),
    skor_bicara: z.string().min(1, "Skor berbicara wajib diisi."),
    skor_menulis: z.string().min(1, "Skor menulis wajib diisi."),
...
const TambahKemampuanBahasa = () => {
    ...
    const onSubmit = (values: FormSchemaType) => {
        ...
        formData.append("skor_mendengar", values.skor_mendengar);
        formData.append("skor_bicara", values.skor_bicara);
        formData.append("skor_menulis", values.skor_menulis);
        ...
        <div className="mt-10 mb-20">
            ...
            /> */}
                        ...
                        <InfiniteScrollSelect
                            ...
                            required
                            queryKey="master_bahasa_admin_tambah"
                        ...
                        <FormFieldInput
                            ...
                            name="skor_mendengar"
                            required
                            placeholder="Masukan skor kemampuan mendengar..."
                            labelStyle="text-[#3F6FA9]"
                        />
                        ...
                        <FormFieldInput
                            ...
                            name="skor_berbicara"
                            required
                            placeholder="Masukan skor kemampuan berbicara..."
                            labelStyle="text-[#3F6FA9]"
                        />
                        ...
                        <FormFieldInput
                            ...
                            name="skor_menulis"
                            required
                            placeholder="Masukan skor kemampuan menulis..."
                            labelStyle="text-[#3F6FA9]"
                        />
