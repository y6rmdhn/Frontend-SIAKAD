...
const Organisasi = () => {
  ...
  const { data } = useQuery({
    ...
    queryFn: async () => {
      const response = await adminServices.getOrganisasiValidasiData(
  ...
  return (
    <div className="mt-10 mb-20">
      <Title title="Validasi" subTitle="Daftar Organisasi Pegawai" />
      ...
      <Table className="mt-10 table-auto text-xs lg:text-sm">
        <TableHeader>
          <TableRow className="bg-gray-100">
            ...
            <TableHead className="text-center">Nama Organisasi</TableHead>
            ...
            <TableRow key={item.id} className=" even:bg-gray-100">
              ...
              <TableCell className="text-center">
                {item.timestamps.tgl_disetujui
                  ? format(
                      parseISO(item.timestamps.tgl_disetujui),
                      "dd MMMM yyyy"
                    )
                  : "-"}
              </TableCell>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmitData)}>
              ...
              <DialogFooter>
                ...
                <Button
                  type="button" // <-- Ubah ke "button"
                  onClick={handleConfirmAction} // <-- Tambahkan handler baru
                  className={
                    pendingAction
