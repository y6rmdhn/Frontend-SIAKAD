...
const Sertifikasi = () => {
  ...
  const { data } = useQuery({
    ...
    queryFn: async () => {
      const response = await adminServices.getSertifikasiValidasiData(
      ...
      <Table className="mt-10 table-auto">
        <TableHeader>
          <TableRow className="bg-gray-100">
            ...
            <TableHead className="text-center">Tahun Seritifikasi</TableHead>
            <TableHead className="text-center">Jenis Sertifikasi</TableHead>
            <TableHead className="text-center">Nomor Sertifikasi</TableHead>
