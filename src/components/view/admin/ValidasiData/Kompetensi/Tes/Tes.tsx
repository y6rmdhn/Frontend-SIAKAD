...
const Tes = () => {
  ...
  const { data } = useQuery({
    ...
    queryFn: async () => {
      const response = await adminServices.getTesKompetensi(
      ...
      <Table className="mt-10 table-auto">
        <TableHeader>
          <TableRow className="bg-gray-100">
            ...
            <TableHead className="text-center">Tahun Tes</TableHead>
            <TableHead className="text-center">Jenis Tes</TableHead>
            <TableHead className="text-center">Nama Tes</TableHead>
