...
const PenghargaanPenunjang = () => {
  ...
  const { data } = useQuery({
    ...
    queryFn: async () => {
      const response = await adminServices.getPenghargaanValidasiData(
  ...
  return (
    <div className="mt-10 mb-20">
      <Title title="Validasi" subTitle="Daftar Pengembangan" />
      ...
      <Table className="mt-10 table-auto text-xs lg:text-sm">
        <TableHeader>
          <TableRow className="bg-gray-100">
            ...
            <TableHead className="text-center">Nama Penghargaan</TableHead>
