...
const OrganisasiPenunjang = () => {
  return (
    <div className="mt-10 mb-20">
      <Title title="Validasi" subTitle="Daftar Anggota Profesi" />
      ...
      <Table className="mt-10 table-auto text-xs lg:text-sm">
        <TableHeader>
          <TableRow className="bg-gray-100">
            ...
            <TableHead className="text-center">Peran/Kedudukan</TableHead>
            <TableHead className="text-center">Waktu Keanggotaan</TableHead>
