...
const PendidikanFormalValidasi = () => {
    return (
        <div className="mt-10 mb-20">
            <Title title="Validasi" subTitle="Riwayat Pendidikan Formal Pegawai" />
            ...
            <Table className="mt-10 table-auto text-xs lg:text-sm">
                <TableHeader>
                    <TableRow className="bg-gray-100">
                        ...
                        <TableHead className="text-center">Nama Institusi</TableHead>
                    ...
                    <TableRow className=" even:bg-gray-100">
                        ...
                        <TableCell className="h-full">
                            <div className="flex justify-center items-center w-full h-full">
                                <Link to="/admin/validasi-data/kualifikasi/pendidikan-formal/detail-pendidikan-formal">
                                    <Button
                                        size="icon"
                                        variant="ghost"
