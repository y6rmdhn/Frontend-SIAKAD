...
const RiwayatPekerjaanValidasi = () => {
    return (
        <div className="mt-10 mb-20">
            <Title title="Validasi" subTitle="Riwayat Pekerjaan Pegawai" />
            ...
            <Table className="mt-10 table-auto text-xs lg:text-sm">
                <TableHeader>
                    <TableRow className="bg-gray-100">
                        ...
                        <TableHead className="text-center">Jenis Pekerjaan</TableHead>
                        <TableHead className="text-center">Area Pekerjaan</TableHead>
                        <TableHead className="text-center">Tgl Diajukan</TableHead>
