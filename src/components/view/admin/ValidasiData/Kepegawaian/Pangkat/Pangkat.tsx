...
const Pangkat = () => {
  ...
  const { data } = useQuery({
    ...
    queryFn: async () => {
      const response = await adminServices.getPangkatValidasiData(
      ...
      <Table className="mt-10 table-auto text-xs lg:text-sm">
        <TableHeader>
          <TableRow className="bg-gray-100">
            ...
            <TableHead className="text-center">Nama Pangkat</TableHead>
            <TableHead className="text-center">TMT Pangkat</TableHead>
            <TableHead className="text-center">Jenis SK</TableHead>
            <TableHead className="text-center">File Pangkat</TableHead>
            ...
            <TableRow key={item.id} className=" even:bg-gray-100">
              ...
              <TableCell className="text-center">
                {item.tgl_disetujui_formatted
                  ? formatDate(item.tgl_disetujui_formatted)
                  : "-"}
              </TableCell>
              <TableCell className="text-center">
                <Button
