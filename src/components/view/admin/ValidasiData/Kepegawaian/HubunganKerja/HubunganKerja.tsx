...
interface HubunganKerjaItem {
  ...
  hubungan_kerja?: { nama: string };
  status_aktif?: { nama: string };
...
// Helper: tanggal yang relevan sesuai status
const getRelevantDate = (item: HubunganKerjaItem) => {
...
const HubunganKerjaKepegawaian = () => {
  ...
  const { data: unitKerjaOptions } = useQuery<{ id: string; nama: string }[]>({
    ...
    queryFn: async () => {
      ...
      // Response is_dropdown: true → data.items langsung array
  ...
  // Status options (static sesuai enum BE)
  const statusOptions = [
    ...
    <div className="mt-10 mb-20">
      ...
      <div className="flex flex-col md:flex-row md:justify-between mt-10 gap-4">
        ...
        <div className="flex flex-col md:flex-row gap-2 items-start md:items-center">
          ...
          {/* Tombol tambah mengarah ke form tambah hubungan kerja admin */}
          <Link to="/admin/validasi-data/kepegawaian/hubungan-kerja/tambah-hubungan-kerja">
        ...
        <Table className="text-xs lg:text-sm">
          <TableHeader>
            <TableRow className="bg-gray-100 hover:bg-gray-100">
              ...
              <TableHead>Hubungan Kerja</TableHead>
              <TableHead className="text-center">File</TableHead>
              {/* Kolom tanggal dinamis sesuai status aktif filter */}
              ...
              items.map((item) => {
                ...
                return (
                  <TableRow key={item.id} className="even:bg-gray-50">
                    ...
                    {/* Nama Hubungan Kerja */}
                    <TableCell>{item.hubungan_kerja?.nama ?? "-"}</TableCell>
                    {/* File Dokumen */}
                    <TableCell className="text-center">
                    ...
                    {/* Aksi */}
                    <TableCell className="text-center">
                      <Link to={`/admin/validasi-data/kepegawaian/hubungan-kerja/detail-hubungan-kerja/${item.id}`}>
