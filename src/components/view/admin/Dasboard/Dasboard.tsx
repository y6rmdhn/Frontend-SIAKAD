...
const Dasboard = () => {
    ...
    return (
        <div className="mt-10 mb-20">
                ...
                actions={
                    <div className="h-0 flex gap-5 lg:gap-30 md:gap-10 sm:gap-5 sm:h-0 items-center">
                        ...
                        <SelectFilter
                            ...
                            classname="w-40 sm:w-80 md:w-80 lg:w-80 xl:w-80 2xl:w-80" 
            ...
            {data ? (
                <>
                    <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 gap-2 md:gap-5 lg:gap-10 mt-6 sm:gap-3 xl:gap-10 2xl:gap-10">
                        <div
                            className="bg-gradient-to-r from-[#1C8C88] to-[#28BCB7] h-20 xl:h-40 2xl:h-40 lg:h-40 rounded-xl text-white flex items-center justify-center relative sm:h-30 md:h-35">
                        ...
                        <div
                            className="bg-gradient-to-r from-[#5abd1d] to-[#66D820] h-20 xl:h-40 2xl:h-40 lg:h-40 rounded-xl text-white flex items-center justify-center relative sm:h-30 md:h-35">
                            <div className="relative w-full h-full flex items-center justify-center">
                        ...
                        <div
                            className="bg-gradient-to-r from-[#e09808] to-[#FFAC07] h-20 xl:h-40 2xl:h-40 lg:h-40 rounded-xl text-white flex items-center justify-center relative sm:h-30 md:h-35">
                        ...
                        <div
                            className="bg-gradient-to-r from-[#b92916] to-[#D22D17] h-20 xl:h-40 2xl:h-40 lg:h-40 rounded-xl text-white flex items-center justify-center relative sm:h-30 sm:flex sm:items-center sm:justify-center sm:relative md:h-35">
                            <div className="relative w-full h-full flex items-center justify-center sm:flex sm:items-center sm:justify-center sm:relative">
                                <h1 className="text-xs lg:text-lg text-center font-semibold flex flex-col items-center sm:text-xs sm:items-center sm:flex sm:flex-col md:text-sm xl:text-lg 2xl:text-lg">
                    ...
                    <div className="lg:grid lg:grid-cols-2 xl:grid xl:grid-cols-2 2xl:grid 2xl:grid-cols-2 gap-5 mt-10">
