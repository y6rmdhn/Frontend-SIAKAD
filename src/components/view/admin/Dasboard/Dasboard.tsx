...
// Tipe untuk data statistik chart
interface ChartData {
  labels: string[];
  datasets: {
    label: string;
...
// Tipe utama untuk semua data dashboard dari API
...
const Dasboard = () => {
  // Terapkan tipe DashboardData pada useQuery
