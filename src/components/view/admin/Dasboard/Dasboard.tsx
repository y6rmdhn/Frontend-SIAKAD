...
const Dasboard = () => {
  ...
  return (
    <div className="mt-10 mb-20">
      ...
      {data ? (
        <>
          <div className="grid grid-rows-4 md:grid-rows-1 gap-4 md:grid-cols-2 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 md:gap-2 md:gap-5 lg:gap-10 mt-6 sm:gap-3 xl:gap-10 2xl:gap-10">
