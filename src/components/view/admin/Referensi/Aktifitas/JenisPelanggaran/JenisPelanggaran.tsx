...
const JenisPelanggaran = () => {
  const form = useForm<jenisPelanggaranFormvalue>({
    defaultValues: {
      kode: "",
      nama_pelanggaran: "",
    },
  ...
  const { mutate: postData } = useMutation<
    any,
    AxiosError,
    jenisPelanggaranFormvalue
  >({
    mutationFn: (data) => potsReferensiServices.jenisPelanggaran(data),
    onSuccess: () => {
      form.reset();
  ...
  const { mutate: updateData } = useMutation({
    mutationFn: (data: jenisPelanggaranFormvalue) =>
      putReferensiServices.jenisPelanggaran(data.id!, data),
    onSuccess: () => {
      form.reset();
  ...
  const { mutate: deleteData } = useMutation({
    mutationFn: (id: string) =>
      deleteReferensiServices.deteleJenisPelanggaran(id),
    onSuccess: () => {
