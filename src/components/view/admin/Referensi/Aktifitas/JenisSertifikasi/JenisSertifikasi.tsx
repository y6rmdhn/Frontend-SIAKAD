...
const JenisSertifikasi = () => {
  ...
  const { mutate: postJenisSertifikasi } = useMutation({
    mutationFn: (data: IJenisSertifikasi) =>
      potsReferensiServices.jenisSertifikasi(data),
    onSuccess: () => {
      form.reset();
  ...
  const { mutate: putJenisSertifikasi } = useMutation({
    mutationFn: (data: jenisSertifikasiFormvalue) =>
      putReferensiServices.jenisSertifikasi(data.id!, data),
    onSuccess: () => {
  ...
  const { mutate: deleteJenisSertifikasi } = useMutation({
    mutationFn: (id: string) =>
      deleteReferensiServices.deteleJenisSertifikasi(id),
    onSuccess: () => {
