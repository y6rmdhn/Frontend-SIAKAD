...
const JenisCuti = () => {
    ...
    const {mutate: postJenisCuti} = useMutation({
        mutationFn: (data: IJenisCutiPost) => potsReferensiServices.jeniCuti(data),
        onSuccess: () => {
            form.reset();
    ...
    const {mutate: putJenisCuti} = useMutation({
        mutationFn: (data: jenisCutiFormvalue) =>
            putReferensiServices.jenisCuti(data.id!, data),
        onSuccess: () => {
            form.reset();
    ...
    const {mutate: deleteJamKerja} = useMutation({
        mutationFn: (id: number) => deleteReferensiServices.deteleJenisCuti(id),
        onSuccess: () => {
