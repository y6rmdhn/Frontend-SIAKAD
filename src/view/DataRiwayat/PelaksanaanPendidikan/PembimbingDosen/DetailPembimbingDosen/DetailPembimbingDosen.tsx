      ...
      <Form {...form}>
        <form>
          <CustomCard
            actions={
              <div className="flex justify-end gap-2">
                <Link to="/data-riwayat/pelaksanaan-pendidikan/pembimbing-dosen">
                  <Button
                    type="button"
          ...
          >
            ...
            />
            <div className="mt-10 grid grid-rows-6 grid-flow-col gap-2 w-full items-center">
              <FormFieldSelect
              ...
              <FormFieldInput
                ...
                options={[
                  ...
                  { label: "Pencangkokan", value: "pencangkokan" },
                ]}
                labelStyle="text-[#3F6FA9]"
              />
              ...
              <FormFieldInput
                ...
                name="dosenBimbingan"
                placeholder="Cari Dosen Bimbingan"
                form={form}
                required={true}
                labelStyle="text-[#3F6FA9]"
              />
...
export default DetailPembimbingDosen;
