        ...
        <div className="min-h-screen flex">
            ...
            <div className="md:w-[57%] bg-blue-800 relative hidden md:flex items-center justify-center">
                ...
                <div className="relative z-10 p-8 text-center text-white">
                    ...
                    <p className="text-xl mb-2">Sistem Informasi Management Kepegawaian</p>
            ...
            <div className="w-full md:w-[43%] flex items-center justify-center p-8 bg-white">
                <div className="w-full max-w-md">
                    ...
                    <h1 className="text-2xl font-bold text-center mb-30">Masuk dan Verifikasi</h1>
                    ...
                    <div className="mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-white text-gray-500 mt-5 mb-5">atau</span>
                            </div>
                        </div>
                        ...
                        <div className="mt-6">
                            ...
                            >
                                <img src="/images/logo/logo-google.png" alt="Google Logo" className="h-6 mr-2" />
