...
const Dasboard = () => {
  return (
    <div className="mt-10" >
      ...
      <CustomCard
      actions={<div><Label>Unit Kerja</Label><Select >
                    ...
                    <div className="grid grid-cols-4 gap-10">
                      ...
                      <div className="bg-[#66D820] h-40 rounded-md">
                        <h1 className="text-2xl font-semibold">Jumlah Pegawai Pendidik (Akademik)</h1>
                      
                      </div>
                      <div className="bg-[#FFAC07] h-40 rounded-md">
                        <h1 className="text-2xl font-semibold">Jumlah Pegawai Kependidikan (Non Akademik)</h1>
                      
                      </div>
                      <div className="bg-[#D22D17] h-40 rounded-md">
                        <h1 className="text-2xl font-semibold">Jumlah Pegawai Tidak Aktif  </h1>
