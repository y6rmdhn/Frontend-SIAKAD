        ...
        <div className="bg-[#28BCB7] h-40 rounded-md text-white flex items-center justify-center relative">
          <div className="relative w-full h-full flex items-center justify-center">
            <h1 className="text-[20px] font-semibold flex flex-col items-center">
              ...
              <p className="text-2xl font-semibold mt-3">611</p>{" "}
            </h1>
        ...
        <div className="bg-[#66D820] h-40 rounded-md text-white flex items-center justify-center relative">
          <div className="relative w-full h-full flex items-center justify-center">
            <h1 className="text-[20px] text-center font-semibold flex flex-col items-center">
              ...
              <p className="text-2xl font-semibold mt-1">655</p>{" "}
            </h1>
        ...
        <div className="bg-[#FFAC07] h-40 rounded-md text-white flex items-center justify-center relative">
          <div className="relative w-full h-full flex items-center justify-center">
            <h1 className="text-[20px] text-center font-semibold flex flex-col items-center">
              ...
              <p className="text-2xl font-semibold mt-1">319</p>{" "}
            </h1>
        ...
        <div className="bg-[#D22D17] h-40 rounded-md text-white flex items-center justify-center relative">
          <div className="relative w-full h-full flex items-center justify-center">
            <h1 className="text-[20px] text-center font-semibold flex flex-col items-center">
              ...
              <p className="text-2xl font-semibold mt-1">373</p>{" "}
            </h1>
        ...
        <CustomCard>
          ...
          <div className="flex gap-3">
            <Button
              ...
              className={
                aktifBtn === "Fungsional" ? "bg-[#FFAC07]" : "bg-[#CDCDCD]"
              }
            >
              Fungsional
            </Button>
            <Button
              ...
              className={
                aktifBtn === "Hubungan Kerja" ? "bg-[#FFAC07]" : "bg-[#CDCDCD]"
              }
            >
              Hubungan Kerja
            </Button>
            <Button
              ...
              className={
                aktifBtn === "Pendidikan" ? "bg-[#FFAC07]" : "bg-[#CDCDCD]"
              }
            >
              Pendidikan
            </Button>
