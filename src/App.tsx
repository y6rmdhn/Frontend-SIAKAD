...
const DetailDiklatValidasiPage = lazy(
  () => import("./pages/admin/validasiData/Kualifikasi/diklatValidasi/detaildiklatValidasi")
)
...
const DetailPendidikanFormalValidasiPage = lazy(
  () => import("./pages/admin/validasiData/Kualifikasi/pendidikanformalValidasi/detailpendidikanformalValidasi")
)
...
const DetailRiwayatPekerjaanValidasiPage = lazy(
  () => import("./pages/admin/validasiData/Kualifikasi/riwayatpekerjaanValidasi/detailriwayatpekerjaanValidasi")
)
